    ...
    public class EmployeeController : Controller
    {
        ...
        public ActionResult AddOrEdit(mvcEmployeeModel emp )
        {
            if (emp.EmployeeID == 0)
            {
                ...
                TempData["SucessMessage"] = "Registro creado exitosamente";
            }
            else
            {
                HttpResponseMessage response = GlobalVariables.WebApiClient.PutAsJsonAsync("Employee/"+emp.EmployeeID, emp).Result;
                TempData["SucessMessage"] = "Registro actualizado exitosamente";
        ...
        public ActionResult Delete (int id)
        {
            ...
            TempData["SucessMessage"] = "Registro eliminado exitosamente";
            return RedirectToAction("Index");
